...
function applyPhase2Optimization(phase0_1Result, optimizationLevel, advancedOverrides = {}) {
  ...
  if (advancedOverrides.attributeCleanup !== undefined) config.attributeCleanup.enabled = advancedOverrides.attributeCleanup
  if (advancedOverrides.precisionReduction !== undefined) config.precisionReduction.enabled = advancedOverrides.precisionReduction
  if (advancedOverrides.decimals !== undefined) config.precisionReduction.decimals = advancedOverrides.decimals
  if (advancedOverrides.shapeConversion !== undefined) config.shapeConversion.enabled = advancedOverrides.shapeConversion
  if (advancedOverrides.pathMerging !== undefined) config.pathMerging.enabled = advancedOverrides.pathMerging
  if (advancedOverrides.idCleanup !== undefined) config.idCleanup.mode = advancedOverrides.idCleanup
  if (advancedOverrides.textHandling !== undefined) config.textHandling.mode = advancedOverrides.textHandling
