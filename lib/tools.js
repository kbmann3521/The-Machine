  ...
  'http-header-parser': {
    ...
    detailedDescription: {
      ...
      features: [
        ...
        'Header validation with warnings and errors',
        ...
        'Multi-format export (plain text, cURL, JSON)',
...
test@cock.li`
  ...
  'http-header-parser': () => [
    // A+ Grade (95+) - Best security practices
    'HTTP/1.1 200 OK\nStrict-Transport-Security: max-age=31536000; includeSubDomains\nX-Content-Type-Options: nosniff\nContent-Security-Policy: default-src \'self\'; script-src \'self\' \'unsafe-inline\'; style-src \'self\' \'unsafe-inline\'\nX-Frame-Options: DENY\nReferrer-Policy: strict-origin-when-cross-origin\nPermissions-Policy: camera=(), microphone=(), geolocation=()\nContent-Type: application/json; charset=utf-8\nContent-Encoding: gzip\nContent-Length: 348\nConnection: keep-alive\nCache-Control: max-age=3600, private\nETag: "abc123"\nLast-Modified: Mon, 01 Jan 2024 00:00:00 GMT',

    // C+ Grade (65-69) - Moderate security (missing critical headers)
    'HTTP/1.1 200 OK\nContent-Type: application/json; charset=utf-8\nContent-Length: 256\nConnection: keep-alive\nAuthorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0In0.signature\nX-Custom-Header: custom-value\nCache-Control: max-age=3600, public',

    // D Grade (45-54) - Poor security (missing most headers, minimal config)
    'HTTP/1.1 200 OK\nContent-Type: text/html\nContent-Length: 1024\nConnection: close',

    // F Grade (<40) - Very poor security (insecure patterns)
    'HTTP/1.1 200 OK\nContent-Type: text/plain\nAuthorization: Bearer sk_test_insecure_token_visible\nCache-Control: max-age=0, public',

    // B- Grade (70-74) - Good but missing some headers
