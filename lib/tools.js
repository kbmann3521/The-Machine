...
export const TOOLS = {
  'text-toolkit': {
    name: 'Text Toolkit',
    description: 'Analyze, transform, and understand text with readability scoring, case conversion, slug generation, and more',
    ...
    detailedDescription: {
      overview: 'The Text Toolkit is a comprehensive solution for analyzing and transforming text. It combines 9+ text processing utilities into one unified interface: readability analysis, word statistics, case conversion, slug generation, find/replace, text diffing, line sorting, delimiter conversion, and advanced text cleaning with support for PDF artifact removal, whitespace normalization, and invisible character handling.',
      howtouse: [
        'Paste or type any text into the input field',
        'Word Counter: word/character/sentence/paragraph counts and metrics',
        'Text Analyzer: readability scores (Flesch, Gunning Fog), grade level, keyword extraction',
        'Case Converter: uppercase, lowercase, titlecase, sentencecase transformations',
        'Slug Generator: create URL-friendly slugs with configurable separators',
        'Reverse Text: character-reversed output',
        'Whitespace Visualizer: visualize spaces, tabs, and invisible formatting',
        'Sort Lines: sort lines alphabetically (asc/desc/by length), remove duplicates',
        'Find & Replace: search and replace with optional regex support',
        'Text Diff: line-by-line comparison between two texts',
        'Delimiter Transformer: convert between delimiters (tabs, commas, newlines)',
        'Clean Text: advanced cleanup (remove PDF artifacts, invisible unicode, HTML/Markdown, normalize whitespace, smart word-joining, etc.)',
        'Copy individual results as needed',
      ],
      features: [
        'Word/character/sentence/paragraph counting and statistics',
        'Readability analysis (Flesch, Gunning Fog, Coleman-Liau indices) with grade level',
        'Lexical density and keyword extraction',
        'Case transformations (uppercase, lowercase, title, sentence)',
        'URL slug generation with configurable separators',
        'Text reversal and whitespace visualization',
        'Find and replace with optional regex pattern support',
        'Line sorting with multiple options (alphabetical, length, numeric, reverse, remove duplicates)',
        'Line-by-line text diff/comparison',
        'Delimiter transformation (convert between tabs, commas, pipes, spaces)',
        'Advanced text cleaning: PDF artifact removal, invisible character removal, HTML/Markdown stripping, whitespace normalization, line trimming, blank line removal, smart word-joining',
        'Configurable character filtering (ASCII-only, keep accents, basic punctuation)',
      ],
      usecases: [
        'Analyze readability and grade level of content for target audience',
        'Generate URL slugs from article titles or headings',
        'Compare or diff two versions of text',
        'Clean text extracted from PDFs or other sources',
        'Remove invisible characters and normalize whitespace',
        'Sort and deduplicate lists of items',
        'Transform text case for different contexts (titles, URLs, commands)',
        'Extract keywords and perform basic SEO analysis',
        'Convert between different text delimiters (CSV↔TSV, etc.)',
        'Prepare text data for processing or import',
        'Debug text with invisible character visualization',
      ],
    },
  },
  'image-toolkit': {
  ...
  'base64-converter': {
    ...
    description: 'Encode and decode Base64 with auto-detection, multiple output variants (standard, URL-safe, MIME, padded/unpadded), and comprehensive metadata',
    toolGroup: 'Text & Encoding',
    category: 'encoding',
    inputTypes: ['text'],
    outputType: 'text',
  ...
  'json-formatter': {
    name: 'JSON Formatter',
    description: 'Beautify, minify, validate, sort, flatten, and convert JSON to other formats with error detection',
  ...
  'regex-tester': {
    name: 'Regex Tester',
    description: 'Test regex patterns against sample text with real-time match highlighting, capture groups, and replacement testing',
    toolGroup: 'Text & Encoding',
    category: 'developer',
    inputTypes: ['text'],
    outputType: 'json',
  ...
  'csv-json-converter': {
    ...
    description: 'Convert spreadsheet data (CSV) to JSON, SQL, JavaScript, or TypeScript with automatic delimiter detection',
    toolGroup: 'Data Formats & Languages',
    category: 'converter',
    inputTypes: ['text'],
    outputType: 'json',
...
Bob Johnson,bob@example.com,45,false`,
  ...
  'xml-formatter': {
    name: 'XML Formatter',
    description: 'Format, minify, validate, convert to JSON/YAML, and run XPath queries on XML documents',
    toolGroup: 'Data Formats & Languages',
    category: 'formatter',
    inputTypes: ['text'],
    outputType: 'text',
...
<configuration xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
  ...
  'yaml-formatter': {
    name: 'YAML Formatter',
    description: 'Format, validate, and convert YAML to JSON and other formats with error detection',
    category: 'formatter',
    inputTypes: ['text'],
    outputType: 'text',
  ...
  'url-toolkit': {
    name: 'URL Toolkit',
    description: 'Parse, analyze, and optimize URLs with domain extraction, tracking parameter removal, SEO analysis, and security grading',
    category: 'developer',
    inputTypes: ['text'],
    outputType: 'json',
  ...
  'jwt-decoder': {
    name: 'JWT Decoder',
    description: 'Decode JSON Web Tokens to inspect headers, payloads, and verify signatures with JWKS support',
    category: 'crypto',
    inputTypes: ['text'],
    outputType: 'json',
  ...
  'color-converter': {
    ...
    description: 'Convert colors between RGB, HEX, HSL, and other formats with color comparisons and palette tools',
    category: 'converter',
    inputTypes: ['text'],
    outputType: 'json',
  ...
  'checksum-calculator': {
    ...
    description: 'Calculate checksums and hashes using 11+ algorithms (MD5, SHA, CRC, etc.) for file integrity verification',
    category: 'crypto',
    inputTypes: ['text'],
    outputType: 'json',
  ...
  'escape-unescape': {
    ...
    description: 'Convert text between escaped and unescaped formats for JavaScript, JSON, HTML, and CSV standards',
    category: 'writing',
    inputTypes: ['text'],
    outputType: 'text',
  ...
  'ascii-unicode-converter': {
    ...
    description: 'Convert text characters to ASCII/Unicode numeric codes and back for character encoding work',
    category: 'converter',
    inputTypes: ['text'],
    outputType: 'json',
    example: 'Hello',
  ...
  'caesar-cipher': {
    name: 'Caesar Cipher',
    description: 'Encrypt text by shifting letters with configurable shift amount or ROT13, with brute force analysis',
    category: 'crypto',
    inputTypes: ['text'],
    outputType: 'text',
  ...
  'css-formatter': {
    name: 'CSS Formatter',
    description: 'Format, minify, validate, and lint CSS with vendor prefixing and error detection',
    toolGroup: 'Data Formats & Languages',
    category: 'formatter',
    inputTypes: ['text'],
    outputType: 'text',
  ...
  'sql-formatter': {
    name: 'SQL Formatter',
    description: 'Format and beautify SQL queries for any dialect with linting and validation',
    category: 'formatter',
    inputTypes: ['text'],
    outputType: 'json',
  ...
  'http-status-lookup': {
    ...
    description: 'Look up HTTP status codes, extract from logs, and get explanations with developer guidance',
    category: 'developer',
    inputTypes: ['text'],
    outputType: 'json',
  ...
  'mime-type-lookup': {
    ...
    description: 'Look up file extensions, MIME types, and security information with reverse lookups',
    category: 'developer',
    inputTypes: ['text'],
    outputType: 'json',
  ...
  'http-header-parser': {
    ...
    description: 'Parse and validate HTTP headers with security analysis and caching behavior simulation',
    category: 'developer',
    inputTypes: ['text'],
    outputType: 'json',
  ...
  'svg-optimizer': {
    name: 'SVG Optimizer',
    description: 'Minify and optimize SVG files by removing unnecessary content with detailed analysis',
    category: 'formatter',
    inputTypes: ['text'],
    outputType: 'json',
  ...
  'unit-converter': {
    ...
    name: 'Unit Converter',
    description: 'Convert between length, mass, temperature, and volume units with intelligent unit auto-detection',
    category: 'converter',
    inputTypes: ['text'],
    outputType: 'json',
  ...
  'number-formatter': {
    ...
    description: 'Format numbers with thousands separators, decimals, percentages, and currency conversions',
  ...
  'base-converter': {
    name: 'Base Converter',
    description: 'Convert numbers between binary, octal, decimal, and hexadecimal with auto-detection of input format',
    category: 'converter',
    inputTypes: ['text'],
    outputType: 'json',
  ...
  'math-evaluator': {
    ...
    description: 'Evaluate mathematical expressions with 30+ functions, high precision, and formula validation',
  ...
  'file-size-converter': {
    ...
    description: 'Convert between bytes, KB, MB, GB, TB, and PB with automatic unit detection',
    category: 'converter',
    inputTypes: ['text'],
    outputType: 'json',
  ...
  'js-formatter': {
    ...
    description: 'Format, minify, lint, and analyze JavaScript code with style rules and error detection',
    category: 'formatter',
    inputTypes: ['text'],
    outputType: 'json',
...
add(1,2)`,
  ...
  'email-validator': {
    ...
    description: 'Enterprise-grade email validation with syntax checking, disposable domain detection, TLD validation, reputation scoring, and multi-dimensional trust analysis',
    category: 'validator',
    inputTypes: ['text'],
    outputType: 'json',
    ...
    configSchema: [],
    detailedDescription: {
      overview: 'The Email Validator is a professional tool with RFC-compliance checking, Punycode normalization, disposable/temporary domain detection (55,000+ domains), role-based identification, free/provider detection, and multi-dimensional scoring (deliverability, trust, gibberish, phishing risk).',
      howtouse: [
        'Enter email address(es): single, comma-separated, or newline-separated for batch processing',
        'View comprehensive validation results with multiple scoring dimensions',
        'Check Syntax Result, Deliverability, Trust Score, Reputation, and Risk Assessment',
        'Export results for list cleaning, form validation, or data quality audits',
      ],
      features: [
        'RFC 5321/5322 syntax validation with Punycode support',
        'TLD (Top-Level Domain) validation',
        'Disposable/temporary email detection (55,000+ domains list)',
        'Free email provider detection (Gmail, Yahoo, Outlook, etc.)',
        'Role-based email detection (admin@, info@, noreply@, postmaster@, etc.)',
        'Multi-dimensional scoring: Deliverability, Trust, Gibberish Detection, Phishing Risk',
        'Combined grade (A/B/C/D) based on multiple factors',
        'Reputation analysis and risk assessment',
        'Batch validation: process multiple emails at once',
        'Detailed results per email with actionable feedback',
        'Human-likelihood heuristics',
      ],
      usecases: [
        'User registration and form validation',
        'Email list hygiene and cleaning',
        'Preventing throwaway email registrations',
        'Data quality assurance for mailing lists',
        'Lead validation and enrichment',
        'Fraud prevention during sign-up',
        'Compliance validation for contact lists',
        'Bulk email validation for marketing campaigns',
      ],
    },
  },
  'web-playground': {
    name: 'Web Playground',
    description: 'Validate, format, and convert Markdown and HTML with syntax checking, accessibility linting, and beautification',
    category: 'formatter',
    inputTypes: ['text'],
    outputType: 'text',
...
*Last updated: 2024*`,
    ...
    show_in_recommendations: true,
    detailedDescription: {
      overview: 'The Web Playground is a comprehensive tool for validating, formatting, converting, and linting Markdown and HTML content. It performs structural validation (unclosed tags, syntax errors), accessibility linting (missing alt text, label references), semantic checks (heading structure, duplicate headings), best practice warnings (deprecated tags, inline styles), and supports conversion between formats with beautification or minification.',
      howtouse: [
        'Paste your Markdown or HTML content into the input',
        'Review the Validation & Linting Results tab for syntax errors, accessibility issues, and best practice warnings',
        'Toggle "Show Validation" to check for structural errors (unclosed tags, mismatched brackets, incomplete syntax)',
        'Toggle "Show Linting" to see advisory warnings about accessibility, best practices, semantic structure, and style issues',
        'Select conversion type (None, HTML, or Markdown) if you want to convert between formats',
        'Choose indentation style and toggle minify/beautify as needed',
        'Use GitHub Markdown Features (GFM) toggle to enable/disable tables, task lists, strikethrough',
        'Copy the formatted output or use it as validation feedback for your documents',
      ],
      features: [
        'Validate Markdown syntax (unclosed code blocks, unmatched brackets, broken links)',
        'Validate HTML syntax (unclosed tags, mismatched quotes, incomplete attributes)',
        'Lint Markdown for best practices (trailing whitespace, heading structure, bare URLs, list format)',
        'Lint HTML for accessibility (missing alt text, empty buttons, missing labels, label-for references)',
        'Check for semantic issues (multiple H1 tags, heading level skips, duplicate headings)',
        'Warn about deprecated tags and attributes (font, center, align, bgcolor, etc.)',
        'Convert Markdown to HTML with proper structure',
        'Convert HTML to Markdown with format preservation',
        'Beautify with configurable indentation (2 spaces, 4 spaces, tab)',
        'Minify HTML/Markdown for production',
        'Auto-detect input type (Markdown, HTML, or mixed)',
        'Support GitHub Flavored Markdown (tables, task lists, strikethrough)',
        'Handle mixed Markdown and HTML content intelligently',
      ],
      usecases: [
        'Check Markdown and HTML documents for syntax errors before publishing',
        'Validate HTML accessibility compliance (alt text, labels, semantic structure)',
        'Audit code for deprecated HTML tags and attributes',
        'Ensure proper heading hierarchy and document structure',
        'Convert Markdown documentation to HTML for web publishing',
        'Convert HTML pages to Markdown for version control and editing',
        'Beautify messy HTML/Markdown for readability and maintenance',
        'Minify HTML and Markdown for production optimization',
        'Fix common formatting issues (trailing whitespace, unmatched brackets, bare URLs)',
        'Prepare content for web publishing with quality checks',
      ],
    },
  },
  'ip-address-toolkit': {
  ...
  'qr-code-generator': {
    ...
    description: 'Generate QR codes from text, URLs, or any data with customizable size, colors, and error correction',
    category: 'generator',
    inputTypes: ['text'],
    outputType: 'json',
...
export async function runTool(toolId, inputText, config, inputImage = null) {
  switch (toolId) {
    ...
    case 'web-playground':
      ...
      return markdownFormatter(inputText, config)
    case 'xml-formatter':
      if (!xmlFormatter) {
