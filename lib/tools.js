...
// htmlFormatter, htmlEncoder, htmlDecoder removed - not used in lib/tools.js
// (markdownFormatter imports them directly from htmlFormatter when needed)
const { markdownHtmlFormatter } = require('./tools/markdownFormatter')
