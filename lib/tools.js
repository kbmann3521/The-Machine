...
Bob Johnson,bob@example.com,45,false`,
  ...
  'time-normalizer': {
    ...
    configSchema: [],
    detailedDescription: {
      overview: 'The Time Normalizer tool converts and normalizes times across different timezones worldwide. Perfect for coordinating across global teams and international scheduling.',
      howtouse: [
