...
export const TOOLS = {
  ...
  'image-toolkit': {
    ...
    detailedDescription: {
      overview: 'The Image Toolkit provides powerful image resizing with fine-grained control. Resize images to specific dimensions, scale them by percentage, or constrain by maximum width with adjustable quality compression.',
      howtouse: [
        'Upload or drag and drop an image into the input area',
        'Select your resize mode: Fixed Dimensions, Scale Percentage, or Max Width',
        'Enter your desired dimensions or scale percentage',
        'Adjust the quality slider for compression control (0-100%)',
        'View the resized image and download or copy as needed',
      ],
      features: [
        'Multiple resize modes for different use cases',
        'Maintain aspect ratio option to prevent image distortion',
        'Quality slider for precise compression control (0-100%)',
