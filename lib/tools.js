...
<configuration xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
  ...
  'css-formatter': {
    name: 'CSS Toolkit',
    description: 'Format, minify, validate, lint, and optimize CSS with autoprefixer support',
    toolGroup: 'Data Formats & Languages',
    category: 'formatter',
    inputTypes: ['text'],
    outputType: 'text',
    ...
    detailedDescription: {
      overview: 'The CSS Toolkit beautifies messy CSS with proper indentation and line breaks for readability, or minifies it to reduce file size. Includes validation, linting, and autoprefixer support. Useful for debugging and production optimization.',
      howtouse: [
        'Paste your CSS code',
...
*Last updated: 2024*`,
    ...
    show_in_recommendations: true,
    detailedDescription: {
      overview: 'The Markdown + HTML Formatter is a versatile tool for converting, formatting, and beautifying Markdown or HTML content with flexible preview controls. It supports converting between formats, beautifying with proper indentation, minifying for production, and customizing how embedded HTML renders in the live preview.',
      howtouse: [
        ...
        'Use the Enable HTML toggle to decide whether inline HTML renders or stays escaped in the preview',
      ...
      features: [
        ...
        'Toggle raw HTML rendering in the preview',
      ...
      usecases: [
        ...
        'Control how embedded HTML renders during Markdown previews',
