  ...
  'email-validator': {
    ...
    detailedDescription: {
      ...
      howtouse: [
        ...
        'Review detailed scoring: Domain Health Score (infrastructure quality), Local-Part Credibility Score (identity quality), and combined Campaign Readiness (0-100)',
      ...
      features: [
        ...
        'Multi-dimensional scoring: Domain Health Score, Local-Part Credibility Score, Campaign Readiness Score (0-100)',
        ...
        'Advanced filtering: by status, score range, TLD quality, gibberish level, role-based, MX records, SPF, DMARC',
