...
export const TOOLS = {
  ...
  'encoder-decoder': {
    ...
    detailedDescription: {
      ...
      features: ['Composable transformer chains - stack multiple encoders together', 'Real-time preview of transformations', 'Individual options for each transformer', 'Toggle between encode and decode directions', 'Support for Base64, URL encoding, Hexadecimal, Binary, ASCII/Unicode, Caesar Cipher', 'Easy add/remove transformers'],
