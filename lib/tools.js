...
add(1,2)`,
  ...
  'web-playground': {
    name: 'Web Playground',
    description: 'Free, deterministic Markdown/HTML validation, formatting, and conversion with syntax checking, accessibility linting, and beautification',
    category: 'formatter',
    inputTypes: ['text'],
    outputType: 'text',
...
alice_smith@company.co.uk
bob.johnson1994@sub.domain.example.com
contact@mysite.org`,
    `info@pioneerwebtools.com
support@pioneerwebtools.com
dev@company.io
