  ...
  switch (mode) {
    ...
    default:
      ...
      return {
        ...
        metadata: {
          timeLow: validation.timeLow,
          timeMid: validation.timeMid,
          timeHigh: validation.timeHigh,
          clockSequence: validation.clockSequence,
          node: validation.node,
          timestamp: validation.timestamp,
          timestampMs: validation.timestampMs,
