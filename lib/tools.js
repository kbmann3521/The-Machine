...
function buildCIDRResult(cidrParsed, rawInput, config) {
  ...
  if (isIPv4) {
    ...
    results.cidr = {
      ...
      hostBits,
      networkBits,
      isNetworkAddress: isNetworkAddress(base, cidr),
      isBroadcastAddress: isBroadcastAddress(base, cidr),
      integer: {
        network: ipv4ToInteger(networkAddress),
        broadcast: ipv4ToInteger(broadcastAddress),
      },
    }
