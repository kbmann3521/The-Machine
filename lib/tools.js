...
const TOOL_EXAMPLES = {
  ...
  'regex-tester': () => [
    ...
    'Order #1234, Order #5678, Order #9012',
    'Name: John Doe, Age: 25, Email: john@example.com',
    'Phone: +1-555-123-4567 or 1 (555) 987-6543',
    'API Key: sk_live_abc123def456ghi789jkl012',
    'Price: $99.99, Total: $299.97',
    'URL: https://www.example.com/path?param=value&id=123#section',
    '2024-01-15T14:30:00Z timestamp format',
    'Log: [ERROR] Failed to connect to database at 14:30:45',
