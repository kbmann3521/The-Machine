...
export function looksLikeNumberWithUnit(input) {
  ...
  const englishStopwords =
    /\b(the|and|or|but|are|is|was|were|have|has|had|here|there|this|that|these|those|with|without|from|into|onto|about|dogs?|cats?)\b/
  ...
  const VALID_UNITS = [
    ...
    'in',
    'inch',
    'inches', // added so "100inches" is detected
    'ft',
    'feet', // common plural
    'yard',
    'yards',
