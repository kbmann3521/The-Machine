export const REGEX_PATTERN_TEMPLATES = {
  ...
  intlPhone: {
    ...
    description: 'Extract international phone numbers with multiple segments and separators',
    pattern: '\\+\\d{1,3}(?:[\\s.\\-]?\\d{1,4}){3,}',
    flags: 'g',
    explanation: 'Matches international phone numbers with country code and supports spaces, dots, and dashes between digit segments. Requires at least 3 additional digit groups after country code.',
    examples: ['+1 212 555 0173', '+44 20 7946 0950', '+61 2 9876 5432', '+44.20.7946.0958'],
  },
  ...
  phoneIntlBroad: {
    ...
    pattern: '\\+\\d{1,4}[\\s.-]?\\d{4,14}',
    flags: 'g',
    explanation: 'Matches international phone format.',
  ...
  hexNumberBatch7: {
    ...
    category: 'Common',
    name: 'Hexadecimal Numbers',
    description: 'Extract hex numbers like 0xFF or FF12AB',
    pattern: '\\b(?:0x)?[A-Fa-f0-9]+\\b',
    flags: 'g',
    explanation: 'Matches hex with or without 0x prefix.',
    examples: [
      '0xFF',
      'A1B2C3'
    ],
