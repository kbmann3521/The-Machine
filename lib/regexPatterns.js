export const REGEX_PATTERN_TEMPLATES = {
  ...
  phoneIntlBroad: {
    ...
    description: 'Extract international phone numbers with flexible formatting and separators',
    pattern: '\\+\\d{1,3}[\\s.\\-]?\\(?\\d{1,4}\\)?(?:[\\s.\\-()]?\\(?\\d{1,4}\\)?){2,}',
    flags: 'g',
    explanation: 'Matches international phone numbers with country code, supporting multiple separators (spaces, dots, dashes, parentheses). Captures segments with optional parentheses around area codes.',
