export const REGEX_PATTERN_TEMPLATES = {
  ...
  intlPhone: {
    ...
    pattern: '\\b\\+\\d{1,3}(?:[\\s.-]?\\d{2,4})+\\b',
    flags: 'g',
    explanation: 'Matches international phone numbers with country code using word boundaries. Supports spaces, dots, and dashes as separators between 2-4 digit segments.',
