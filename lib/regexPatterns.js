export const REGEX_PATTERN_TEMPLATES = {
  ...
  intlPhone: {
    ...
    description: 'Extract international phone numbers with multiple segments',
    pattern: '\\+\\d{1,3}[\\s.-]?\\d{1,4}(?:[\\s.-]?\\d{1,4})*',
    flags: 'g',
    explanation: 'Matches international phone numbers with country code and supports spaces, dots, and dashes as separators between number segments.',
    examples: ['+1-555-123-4567', '+44 20 7946 0958', '+61 2 9876 5432', '+44.20.7946.0958'],
  },
