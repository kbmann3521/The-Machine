...
const nsfwTermsLong = [
  ...
  'solo', 'latex', 'bondage', 'cosplay', 'roleplay',
  ...
  'boobs', 'titties', 'rack', 'jugs', 'breasts',

  'butt', 'booty', 'cheeks', 'thicc', 'thick',
  ...
  'doggystyle', 'doggy', 'cowgirl', 'reversecowgirl',
...
async function validateSingleEmail(trimmedEmail) {
  ...
  // 7 unique signals: Low Pronounceability (merged vowels + consonants), Multiple special chars,
