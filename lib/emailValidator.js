...
function calculateCampaignScore(options) {
  ...
  let label = 'Poor'
  if (campaignScore >= 85) label = 'Excellent'
  else if (campaignScore >= 70) label = 'Good'
  else if (campaignScore >= 50) label = 'Risky'
  else label = 'Poor'
...
export async function emailValidator(text) {
  ...
  if (hasValidEmails) {
    averageCampaignReadiness = 'Poor'
    if (averageCampaignScore >= 85) averageCampaignReadiness = 'Excellent'
    else if (averageCampaignScore >= 70) averageCampaignReadiness = 'Good'
    else if (averageCampaignScore >= 50) averageCampaignReadiness = 'Risky'
  }
