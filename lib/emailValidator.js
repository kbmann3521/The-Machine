...
const abusiveTerms = [
  ...
  'damn', 'hell', 'nigger', 'faggot', 'racist', 'rapist', 'rape', 'sex',
...
// FIX #1: Slang whitelist - real English words that trigger gibberish incorrectly
const slangWhitelist = new Set([
  'shitposter', 'shitposting', 'shitpost'
])

// FIX #4: Adult content terms (not abusive, but should reduce trust)
const adultTerms = new Set(['nsfw', 'porn', 'hentai', 'xxx'])
