...
async function validateSingleEmail(trimmedEmail) {
  ...
  // 8 unique signals: Low Pronounceability (merged vowels + consonants), Multiple special chars,
  // High entropy, Exceptionally long, Numbers-only, Bot patterns, Repeated characters, Scattered letter-number mix
  // 0 signals → 0
  // 1 signal → -5
  // 2 signals → -15 total
  // 3 signals → -30 total
