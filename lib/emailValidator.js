...
export async function emailValidator(text) {
  ...
  const averageIdentityScore = hasValidEmails ? avg('identityScore') : undefined

  // Map average identity score to campaign readiness label (only if valid emails exist)
