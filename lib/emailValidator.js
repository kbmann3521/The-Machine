...
const slangWhitelist = new Set([
  'shitposter', 'shitposting', 'shitpost', 'shitshow',
  'doomscroll', 'doomscrolling', 'sarcasm', 'meme', 'memes',
  'troll', 'trolling', 'lol', 'lmao', 'rofl', 'pwn', 'pwned',
  'noob', 'gamer', 'gaming', 'streamer', 'streaming', 'esports',
  'hacker', 'devops', 'devrel', 'fullstack', 'backend', 'frontend',
  'podcast', 'podcaster', 'vlogger', 'youtuber', 'youtube',
  'spotify', 'fitness', 'yoga', 'crossfit', 'marathon',
  'gonna', 'gotta', 'wanna', 'dunno', 'kinda', 'badass',
  'awesome', 'cool', 'dope', 'epic', 'yolo', 'fomo', 'salty',
  'vibe', 'vibes', 'mood', 'foodie', 'coffee', 'username',
  'alias', 'handle', 'moniker', 'persona', 'nickname'
])
