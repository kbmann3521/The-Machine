...
const abusiveTerms = [
  ...
  'ass', 'asshole', 'dumbass', 'smartass', 'jackass',

  // Sexual insults
  'cunt', 'twat', 'pussy', 'dick', 'dickhead', 'prick',
  'ballsack', 'cockhead', 'coochie',

  // Personal insults
  'idiot', 'moron', 'stupid', 'dumb', 'dumbass', 'loser',
  'clown', 'scumbag', 'weirdo', 'creep', 'trash', 'garbage',
  'pathetic', 'worthless', 'degenerate', 'delusional',
  'psychopath', 'sociopath', 'lunatic', 'fool', 'jerk',
  'coward', 'snake', 'liar', 'douche', 'douchebag',

  // Aggressive terms
  'kill-yourself', 'kys', 'die', 'die-in-a-fire',
  'burn', 'getrekt', 'rekt', 'cringe-lord', 'failure',

  // Hostile slang
  'bastard', 'hoe', 'slut', 'whore', 'skank', 'tramp',
  'manwhore', 'fuk', 'bish', 'bitch', 'bitchass',
  'thot', 'ratchet', 'crackhead', 'junkie',

  // Mocking terms
  'neckbeard', 'virgin', 'simp', 'beta', 'incel',
  'scrub', 'noob', 'tryhard', 'bot'
];
...
const nsfwTerms = [
  ...
  // Porn categories (clean list)
  'porn', 'porno', 'xxx', 'hentai', 'yuri', 'yaoi', 'ecchi',
  'milf', 'gilf', 'teen', 'bbw', 'bj', 'solo', 'amateur',
  'fetish', 'latex', 'bondage', 'cosplay', 'roleplay',

  // Adult industry terms
  'escort', 'callgirl', 'hookup', 'dating', 'swinger',
  'sugarbaby', 'sugardaddy', 'paypig', 'findom',
  ...
  'onlyfansmodel', 'adultcreator',

  // ----------------------------------------------------
  // 🔥 NEW: Anatomical / sexual body-part slang
  // (clean, non-slur, non-violent)
  // ----------------------------------------------------
  'penis', 'dick', 'cock', 'pecker', 'shaft',
  'balls', 'ballbag', 'nutsack',

  'vagina', 'pussy', 'coochie', 'cooch', 'cooter',
  'clit', 'clitoris',

  'boobs', 'tits', 'titties', 'breasts', 'jugs', 'rack',

  'ass', 'booty', 'butt', 'buttcheeks', 'cheeks',
  'thicc', 'thick',

  // ----------------------------------------------------
  // 🔥 NEW: Sexual acts / slang
  // (safe, basic, no slurs, no extreme terms)
  // ----------------------------------------------------
  'handjob', 'hj', 'blowjob', 'bj', 'deepthroat',
  'anal', 'doggystyle', 'doggy', 'cowgirl', 'reversecowgirl',
  'missionary', '69', 'sixtynine',
  'sext', 'sexting',

  // ----------------------------------------------------
  // 🔥 NEW: Mild fetish terms
  // (No illegal, no hate, no violence)
  // ----------------------------------------------------
  'feetpics', 'footfetish', 'footpics',
  'cosplaygirl', 'cosplaybabe',
  'lingerie', 'stockings', 'fishnets',
  'leather', 'ropeplay',
  'spanking', 'tease', 'sensualmassage',

  // ----------------------------------------------------
  // 🔥 NEW: NSFW self-branding words
  // ----------------------------------------------------
  'nudecreator', 'nsfwcreator', 'adultmodel',
