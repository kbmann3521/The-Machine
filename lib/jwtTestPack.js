...
-----END PUBLIC KEY-----`
  ...
  tests: [
    ...
    {
      id: 'ES256_VALID',
      description: 'ES256 token with valid ECDSA signature using P-256 curve. (Node.js only - signature verification requires Node.js crypto)',
      algorithm: 'ES256',
...
-----END PUBLIC KEY-----`,
      expected: {
        signatureVerification: {
          algorithm: 'ES256',
          verified: null,
          reasonIncludes: 'requires Node.js environment'
        }
      }
    },
    ...
    {
      id: 'ES384_VALID',
      description: 'ES384 token with valid ECDSA signature using P-384 curve. (Node.js only - signature verification requires Node.js crypto)',
      algorithm: 'ES384',
