...
-----END PUBLIC KEY-----`
  ...
  tests: [
    ...
    {
      id: 'RS256_VALID_BASE',
      description: 'Canonical RS256 token – signature must verify with correct public key.',
      algorithm: 'RS256',
      ...
      expected: {
        signatureVerification: {
          algorithm: 'RS256',
          verified: true,
          reasonIncludes: 'RSA-SHA256 signature matches token contents'
        }
      }
    },

    {
      id: 'RS256_WRONG_PUBLIC_KEY',
      description: 'Same token as base, but with a different public key – must fail verification.',
      algorithm: 'RS256',
      token: 'eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiYWRtaW4iOnRydWUsImlhdCI6MTUxNjIzOTAyMn0.CeKwW1jALGNRoTxGHwW-mfqW_c9sXZlLNSVMW9xJQlKAZKPfZHLc9hQmKgKXeY5cANtKdVq0hLCx6YqrRGJWNPgXVb_VPxd7Wkm5fvwLDRLNXdkPVUh0Z5lUk-s6_K0PL9RuY3PYcXQKzRQZoJmF0T5NrLnLJKXRLx4VwJVG4P3Q5HY8OzF-Lw0_WqLY_4-Zl8FhWqVqZa0BqZO8E1QZp5K7J5Vm1F1a9mD1mLgPxRe9qLaLd5Z0PqXDjEq9VN6W0KvL0oX-Q_WcL1qZd5sF7QqS0f1mJ5l-y9Oj5gB3n7eF_X1vL5wC7R8hL9_w0X3t9',
      publicKey: 'defaultPublicKeys.rs256_wrong',
      expected: {
        signatureVerification: {
          algorithm: 'RS256',
          verified: false,
    ...
    {
      id: 'RS256_TAMPERED_PAYLOAD',
      description: 'Payload changed (admin: true → false) but signature kept the same – must fail verification.',
      algorithm: 'RS256',
      token: 'eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiYWRtaW4iOmZhbHNlLCJpYXQiOjE1MTYyMzkwMjJ9.CeKwW1jALGNRoTxGHwW-mfqW_c9sXZlLNSVMW9xJQlKAZKPfZHLc9hQmKgKXeY5cANtKdVq0hLCx6YqrRGJWNPgXVb_VPxd7Wkm5fvwLDRLNXdkPVUh0Z5lUk-s6_K0PL9RuY3PYcXQKzRQZoJmF0T5NrLnLJKXRLx4VwJVG4P3Q5HY8OzF-Lw0_WqLY_4-Zl8FhWqVqZa0BqZO8E1QZp5K7J5Vm1F1a9mD1mLgPxRe9qLaLd5Z0PqXDjEq9VN6W0KvL0oX-Q_WcL1qZd5sF7QqS0f1mJ5l-y9Oj5gB3n7eF_X1vL5wC7R8hL9_w0X3t9',
      publicKey: 'defaultPublicKeys.rs256_main',
      expected: {
        signatureVerification: {
          algorithm: 'RS256',
