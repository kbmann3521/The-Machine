...
-----END PUBLIC KEY-----`
  ...
  tests: [
    ...
    {
      id: 'RS256_REAL_WORLD_STRUCTURE',
      description: 'RS256 token simulating a real-world Auth0 ID token structure with standard claims.',
      algorithm: 'RS256',
      token: 'eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6IkY4MEE0MzI1RDY2QzRGNDI5NzM5MDkyQzlGQzVBOUE3In0..dummy_signature',
      publicKey: '',
      options: {
        skipVerification: true
      },
      expected: {
        ...
        decodedHeader: {
          alg: 'RS256',
          kid: 'F80A4325D66C4F42973909C9FC5A9A7'
        },
        decodedPayload: {
          iss: 'https://example.auth0.com/',
          sub: 'auth0|609d29a2bc654e4c50a12b56',
    ...
    {
      id: 'RS256_FIREBASE_STRUCTURE',
      description: 'RS256 token simulating a real Firebase ID token with Firebase-specific claims.',
      algorithm: 'RS256',
    ...
    {
      id: 'RS256_OKTA_STRUCTURE',
      description: 'RS256 token simulating a real Okta ID token with Okta-specific claims.',
      algorithm: 'RS256',
      ...
      expected: {
        ...
        decodedPayload: {
          ...
          aud: '0oa0xbctd5KIQtW0s0.7',
          sub: '00abc12d3eEFMUBcDGWw0'
        }
      }
    }
  ]
