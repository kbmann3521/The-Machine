...
// pgvector in Supabase requires a specific string format: "[x1, x2, x3, ...]"
export function formatEmbeddingForStorage(embedding) {
  if (!Array.isArray(embedding) || embedding.length === 0) {
    return null
  }
  // Format as pgvector string: [value1,value2,value3,...]
  // No spaces after commas for pgvector compatibility
...
export { detectInputPatterns, levenshteinDistance, formatEmbeddingForStorage }
