...
function verifyECSignature(algorithm, rawHeader, rawPayload, signatureB64Url, publicKeyPem) {
  try {
    ...
    if (typeof crypto === 'undefined' || typeof crypto.createVerify !== 'function') {
      // In browser environment - cannot verify with Node.js crypto
      return {
        verified: null,
        reason: `${algorithm} verification requires Node.js. Use browser verification instead.`,
      }
    }
