...
export function jwtDecoder(text, options = {}) {
  ...
  return {
    ...
    signatureVerification: (() => {
      // Phase 3-4B: Signature Verification (HS256/384/512, RS256/384/512, none)
      ...
      if (hmacAlgorithms.includes(alg)) {
        ...
        return {
          algorithm: alg,
          verified: null,
          reason: `${alg} verification is not yet supported. Supported algorithms: HS256, HS384, HS512, RS256, RS384, RS512.`,
        }
      }
    })(),
