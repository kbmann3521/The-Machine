...
function generateSuggestions(tags, classes) {
  ...
  // Add container and layout selectors (WITHOUT prefix - users just write div, section, etc)
  const structureTags = ['div', 'section', 'article', 'nav', 'header', 'footer', 'main', 'aside', 'table', 'thead', 'tbody', 'tr', 'th', 'td', 'blockquote', 'hr']
  ...
  const textTags = ['p', 'em', 'strong', 'small', 'mark', 'del', 'a', 'img', 'ul', 'ol', 'li', 'button', 'input', 'form', 'label', 'textarea', 'select', 'option', 'fieldset', 'span']
