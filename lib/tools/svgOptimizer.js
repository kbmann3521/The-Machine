...
const ATTRIBUTE_ORDER = {
  ...
  'opacity': 31, 'fill-opacity': 31, 'stroke-opacity': 31, 'fill-rule': 31,
  ...
  'stdDeviation': 71, 'in': 71, 'result': 71,
...
function shouldFormatMultiLine(tagName, attrs, hasChildren) {
  ...
  if (attrStr.length > 80) return true

  const mustExpandTags = ['svg', 'defs', 'symbol']
