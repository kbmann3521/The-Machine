...
function yamlFormatter(text, config) {
  ...
  try {
    ...
    const validationResult = yamlValidate(text)
    ...
    switch (mode) {
      case 'beautify':
        formatted = yamlBeautify(text, indentSize)
        break
      case 'minify':
        formatted = yamlMinify(text)
        break
      case 'to-json':
        formatted = yamlToJson(text)
        break
      case 'to-toml':
        formatted = yamlToToml(text)
        break
      case 'to-env':
        formatted = yamlToEnv(text)
        break
      case 'flatten':
        formatted = yamlFlatten(text)
        break
      case 'unflatten':
        formatted = yamlUnflatten(text)
        break
      case 'remove-comments':
        formatted = yamlRemoveComments(text)
        break
      case 'convert-tabs':
        formatted = yamlConvertTabs(text, indentSize)
        break
      case 'detect-unsafe':
        formatted = yamlDetectUnsafe(text)
        break
      default:
        formatted = yamlBeautify(text, indentSize)
    }
    ...
    if (showLinting && isWellFormed && yamlLintModule) {
      try {
        lintingWarnings = yamlLintModule(text) || []
      } catch (lintError) {
