...
/* ============================
 *  MINIFY (COMPACT) - RESPECTS REMOVE COMMENTS TOGGLE
 * ============================ */

function minifyXmlStandard(xmlString) {
  // collapse whitespace between tags (including across lines)
...
function processXmlTool(inputXml, options = {}) {
  ...
  // 4. Cleanup toggles (including removeComments for minify mode)
