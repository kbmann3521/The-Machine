...
/**
 * Public wrapper for xmlFormatter
 * Delegates to the core pipeline while handling config options
 */
...
// Tree-shaking optimized: Only export the public API wrapper
// All other functions are internal utilities that the main xmlFormatter depends on
module.exports = {
  xmlFormatter,  // ← Public wrapper (lazy-loaded from runTool)
};
