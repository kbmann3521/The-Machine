 ...
 */
export function autoRepairXML(xmlString) {
 ...
 */
export function lintXML(xmlString) {
  const warnings = []
 ...
 */
export function applyCleanupOptions(xmlString, options = {}) {
  let out = xmlString
 ...
 */
export function formatFinalXML(xmlString, mode = 'beautify') {
  if (mode === 'minify') {
 ...
 */
export function processXmlTool(inputXml, options = {}) {
