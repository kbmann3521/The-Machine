...
export default function EmailValidatorTool() {
  ...
  const standaloneDetailedDescription = {
    ...
    whatItChecks: [
      ...
      'Domain Trust: TLD quality assessment (high-trust like .com vs suspicious like .xyz), ICANN-approved TLD validation, known disposable/temporary domain detection, free provider identification (Gmail, Yahoo, Outlook, etc.)',
      'Email Identity: Role-based pattern detection (admin, support, noreply, etc.), gibberish/random username scoring, abusive/hateful content detection, semantic quality analysis',
      'Risk Assessment: Phishing risk scoring, brand impersonation detection, credential stuffing signals, suspicious patterns and infrastructure gaps',
      'Scoring & Analysis: Domain Health Score (infrastructure maturity), Local-Part Credibility Score (identity quality), Campaign Readiness Score (0-100 suitability), detailed breakdowns with reasoning',
      'Bulk Processing: Batch validation for email lists, advanced filtering and sorting capabilities, export to CSV with full breakdown and metrics',
    ],
    howToUse: [
