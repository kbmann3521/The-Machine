...
export default function EncoderDecoderTool() {
  const standaloneDetailedDescription = {
    ...
    faq: [
      ...
      { question: 'What transformers are available?', answer: 'Currently supports Base64, URL encoding, Hexadecimal, Binary, ASCII/Unicode, and Caesar Cipher. More will be added soon.' },
