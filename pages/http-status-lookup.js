      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Free HTTP status code lookup tool with auto-detection, explanations, and code examples for multiple frameworks.",
            "applicationCategory": "DeveloperTool",
            "operatingSystem": "Web",
            "url": `${props?.seoSettings?.canonical_base_url || 'https://www.pioneerwebtools.com'}/http-status-lookup`,
            ...
            "featureList": [
              "Auto-detect HTTP status codes from text or logs",
              "Look up status code meanings and explanations",
              "Check retryability and cacheability of responses",
              "View common causes for specific status codes",
              "Get code examples for 9 frameworks",
              "Analyze multiple status codes from logs",
              "Bulk status code lookup from log files",
