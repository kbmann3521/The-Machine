  ...
  return (
    <div className={styles.layout} style={containerStyle}>
      <Head>
        ...
        <link rel="canonical" href={metadata.canonical || `${props?.seoSettings?.canonical_base_url}/xml-formatter` || 'https://www.pioneerwebtools.com/xml-formatter'} />
        ...
        <meta property="og:url" content={metadata.openGraph?.url || `${props?.seoSettings?.canonical_base_url || 'https://www.pioneerwebtools.com'}/xml-formatter`} />
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "name": "XML Formatter",
            "description": "Free online XML formatter with beautification, minification, validation, XPath queries, and conversion to JSON and YAML.",
            "applicationCategory": "DeveloperTool",
            "operatingSystem": "Web",
            "url": `${props?.seoSettings?.canonical_base_url || 'https://www.pioneerwebtools.com'}/xml-formatter`,
            ...
            "featureList": [
              ...
              "Validate XML syntax and catch errors",
              "Execute XPath queries on XML data",
