  ...
  return (
    <div className={styles.layout} style={containerStyle}>
      <Head>
        ...
        <link rel="canonical" href={metadata.canonical || `${props?.seoSettings?.canonical_base_url}/cron-tester` || 'https://www.pioneerwebtools.com/cron-tester'} />
        ...
        <meta property="og:url" content={metadata.openGraph?.url || `${props?.seoSettings?.canonical_base_url || 'https://www.pioneerwebtools.com'}/cron-tester`} />
      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Free online cron expression validator for testing Linux/Unix cron schedules with timezone support.",
            "applicationCategory": "DeveloperTool",
            "operatingSystem": "Web",
            "url": `${props?.seoSettings?.canonical_base_url || 'https://www.pioneerwebtools.com'}/cron-tester`,
            ...
            "featureList": [
              ...
              "Explain minute, hour, day, month, and day of week fields",
              "Detect common cron syntax errors",
              "Timezone-aware scheduling for global jobs",
              "Standard POSIX cron format support",
